# -*- coding: utf-8 -*-
"""
Created on Fri Aug 19 20:00:36 2016
...
###
### v3 -This version, takes frames at a 4X frame rate and uses these frames to find the representative frames. 
### Then it takes one out of every 4 frames to find sampled frames at 1X frame rate. Then it interpolates these frames
### to a 4X frame rate to create sampled interpolated frames. Then it phase stamps the sampled frames to the representative frames found 
### from the original frames. Then it also creates representative frames from the sampled interpolated frames by just chosing the frames
### with the same original frame number as the representative frames did in the original frames. It assumes that the sampled interpolated
### frames and the original frames are essentially the same. Then it phase stamps the avg frames using the sampled interpolated frames as well. 
###############################################################################
###############################################################################
#%%
...
print('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
print('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
print('%%% v3 -This version, takes frames at a 4X frame rate and uses these frames to find the representative frames.  %%%')
print('%%% Then it takes one out of every 4 frames to find sampled frames at 1X frame rate. Then it interpolates these frames %%%')
print('%%% to a 4X frame rate to create sampled interpolated frames. Then it phase stamps the sampled frames to the representative frames found %%%')
print('%%% from the original frames. Then it also creates representative frames from the sampled interpolated frames by just chosing the frames %%%')
print('%%% with the same original frame number as the representative frames did in the original frames. It assumes that the sampled interpolated %%%')
print('%%% frames and the original frames are essentially the same. Then it phase stamps the avg frames using the sampled interpolated frames as well. %%%')
print('%%% %%%')
print('%%% %%%')
print('%%% %%%')
...
location='I:/160719_PhaseStamping_PhaseSupersamplingTest/PhaseStamping_Supersampling_480fps_54hpf_50Kframes_copy3'
